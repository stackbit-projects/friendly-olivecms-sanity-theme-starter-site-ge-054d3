...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/602054d31cef9100162811c0
...
To start editing your site, you can use the Sanity interface at https://friendly-olivecms-sanity-theme-starter-site-ge-054d3.sanity.studio/.
...
Generated at `2021-02-07T21:00:14.911Z` by Stackbit version `0.3.48`.